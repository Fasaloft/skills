...
| Skill | Description |
| --- | --- |
| [`deep-review`](deep-review/SKILL.md) | Systematic, evidence-based PR/MR review. Host-agnostic (GitHub `gh` / GitLab `glab`); covers React 19, TypeScript, Kotlin, module boundaries, and house-rules alignment. |
